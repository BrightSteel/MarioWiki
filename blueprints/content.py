...
def content():
  ...
  if tag:
    ...
    posts = db.get_posts_by_tag_and_category(tag, "content", page=page)
    page_count = utils.get_total_pages(db.get_count_by_tag_and_category(tag, "content")[0])

    all_posts = db.get_all_posts_by_category("content")
  ...
  trending_posts = db.get_trending_posts("content")
  trending = []
  ...
  user_ids = db.get_top_contributors_by_category("content")
  top_contributors = []
  for id in user_ids:
